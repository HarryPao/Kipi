        ...
        if( isset($row['account'])!= "" ){
           $resultStr = '此帳號已經有人註冊！';
            ...
            if(isset($_FILES['image'])){
              ...
              $sth = $dbh->prepare("INSERT INTO user (profile_img) VALUES (?)");
            ...
            if($_POST['account'] != ''){
                ...
                $sth = $dbh->prepare( 'INSERT INTO user (account, pwd, email, birthday, gender, job, education, intro, nickname, authority)
                VALUES (?, md5(?), ?, ?, ?, ?, ?, ?, ?, ?)' );
                $sth->execute(array(
                    $_POST['account'],
                    $_POST['pwd'],
      ...
      <div class="col-submit">
        <div class="input-group">
          ...
          <input type="submit" value="送出">
           <input type="button" value="Login" onclick="self.location.href='https:\/\/107703037.000webhostapp.com/index.php'">
